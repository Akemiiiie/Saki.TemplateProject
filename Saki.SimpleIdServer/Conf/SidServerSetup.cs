...
using Saki.SimpleIdServer.Conf.Migrations.AfterDeployment;
using Saki.SimpleIdServer.Conf.Migrations.BeforeDeployment;
using Saki.SimpleIdServer.Configurations;
using Saki.SimpleIdServer.Consumers;
...
namespace Saki.SimpleIdServer.Conf
{
