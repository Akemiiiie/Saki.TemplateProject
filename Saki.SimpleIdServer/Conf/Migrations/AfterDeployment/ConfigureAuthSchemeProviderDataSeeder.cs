...
using Saki.SimpleIdServer.Converters;
    ...
    public class ConfigureAuthSchemeProviderDataSeeder : BaseAfterDeploymentDataSeeder
    {
        ...
        protected override async Task Execute(CancellationToken cancellationToken)
        {
            using (var transaction = _transactionBuilder.Build())
            {
                ...
                var existingInstances = await _authenticationSchemeProviderRepository.GetAll(DefaultRealms.Master.Name, cancellationToken);
